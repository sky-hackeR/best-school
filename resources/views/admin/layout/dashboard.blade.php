    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="{{ url('/admin/schoolHistory') }}" class="waves-effect">
                                    <i class="bx bx-history"></i>
                                    <span key="t-settings">School History</span>
                                </a>
                            </li>

                            <li>
                                <a href="{{ url('/admin/visionMission') }}" class="waves-effect">
                                    <i class="bx bx-compass"></i>
                                    <span key="t-settings">Vision and Mission</span>
                                </a>
                            </li>

                            <li>
                                <a href="{{ url('/admin/schoolAnthem') }}" class="waves-effect">
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                let stanzaCount =
                    document.querySelectorAll('.stanza-item').length;

                document
                    .getElementById('addStanza')
                    .addEventListener('click', function () {
                        ...
                        let html = `
                            <div class="stanza-item mb-3">
                                ...
                                <textarea
                                    ...
                                    rows="5"
                                    class="form-control"
                                    placeholder="Enter stanza ${stanzaCount}"
                                ></textarea>
                        ...
                        document
                            .getElementById('stanzaContainer')
